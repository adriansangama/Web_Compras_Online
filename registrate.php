      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Regístrate</strong>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12">
            ...
            <form action="sp_insertar.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Contraseña </label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Teléfono </label>
                  ...
                  <div class="col-md-12">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="invalidCheck">
                        Tengo 13 años o más y acepto los términos del Acuerdo de Suscriptor a Adict y la Política de Privacidad de Adict Game.
                      </label>
